...
create table attend_statistics (
  ...
  should_days       int             default 0                  comment '应到天数',
  normal_days       int             default 0                  comment '实到天数',
  late_days         int             default 0                  comment '迟到天数',
  early_days        int             default 0                  comment '早退天数',
  absence_days      int             default 0                  comment '缺勤天数',
  outside_days      int             default 0                  comment '外勤天数',
  over_time_days    int             default 0                  comment '加班天数',
  remark            varchar(500)    default null               comment  '备注',
  primary key (statistics_id)
) engine=innodb auto_increment=1 comment = '考勤统计表';
